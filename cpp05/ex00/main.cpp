...
/*
- исключения не должны быть кононичной формы (остальные должны)
- бюракрат: у него должны быть постоянное (const) имя и оценка (grade) которая 
...
Нужно сделать перегрузку оператора << в ostream оно должно выводить
